...
print('-' * 50)
print(f'Os cinco primeiros colocados da tabela são: {times[:6]}')
print('-' * 50)
print(f'Os quatro últimos colocados da tabela são: {times[:-5:-1]}')
print('-' * 50)
print('Os times em ordem alfabetica são: {} '.format(sorted(times)))
print('-' * 50)
print('A Chapecoense está na {}º colocação'.format(times.index('Chapecoense')+1))
